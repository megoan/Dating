            ...
            Column(
              ...
              children: <Widget>[
                Text('More About Me', style: TextStyle(fontSize: 35, color: Theme.of(context).primaryColor), ),
                 Text('age will be public',style: TextStyle(fontSize: 14,color: Theme.of(context).primaryColor),),
              ],
            ),
          //  
            Column(
            ...
            GradientButton.getGradiantButton(context, addUserMoreMe, 'CONTINUE',
                Colors.black, 20, dateVarified),
          ],
        ),
      ),
    );
