          ...
          children: <Widget>[
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                if(myListSelected)  RaisedButton(onPressed: (){
                  // setState(() {
                ...
                if(!myListSelected) OutlineButton( onPressed: (){   
                  setState(() {
                       myListSelected=!myListSelected;       
                      ...
                      child: Container(
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(LocaleText.getLocaleText(MyApp.getLocale(), 'My list'),style: TextStyle(color: Colors.purple),),
                          ],
                        ),
                      ),
                ...
                if(myFavoritesSelected)  RaisedButton(onPressed: (){
                  // setState(() {
                  ...
                  child: Text(LocaleText.getLocaleText(MyApp.getLocale(), 'Favorites'),style:TextStyle(color: Colors.white)),
                   ...
                   shape: RoundedRectangleBorder(borderRadius: new BorderRadius.circular(30.0))),
                if(!myFavoritesSelected) OutlineButton( onPressed: (){ 
                  setState(() {
                        myFavoritesSelected=!myFavoritesSelected;     
                      ...
                      child: Container(
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(LocaleText.getLocaleText(MyApp.getLocale(), 'Favorites'),style: TextStyle(color: Colors.purple),),
                          ],
                        ),
                      ),
                      shape: new RoundedRectangleBorder(
                 ...
                 if(allSelected)  RaisedButton(onPressed: (){
                  // setState(() {
                  ...
                  child: Text(LocaleText.getLocaleText(MyApp.getLocale(), 'Everyone'),style:TextStyle(color: Colors.white)),
                   ...
                   shape: RoundedRectangleBorder(borderRadius: new BorderRadius.circular(30.0))),
                if(!allSelected) OutlineButton( onPressed: (){   
                  setState(() {
                      allSelected=!allSelected; 
                      myFavoritesSelected= false;
                      myListSelected= false;      
                      ...
                      child: Container(
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(LocaleText.getLocaleText(MyApp.getLocale(), 'Everyone'),style: TextStyle(color: Colors.purple),),
                          ],
                        ),
                      ),
                      shape: new RoundedRectangleBorder(
